# Phase 7B Sanity Fixture Results
...
| qb_elite_vs_core_rb_wr_003 | ready | high | acceptable model disagreement |
| qb_replaceable_control_002 | ready | medium | acceptable model disagreement |
| qb_lamar_niners_sensitivity_004 | ready | high | acceptable model disagreement |
