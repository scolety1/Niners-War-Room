...
from src.services.model_v4_rotowire_player_stats_intake_service import (  # noqa: E402
    DEFAULT_OUTPUT_ROOT,
...
def main() -> None:
    ...
    paths = write_rotowire_player_stats_intake_outputs(DEFAULT_OUTPUT_ROOT, result)
