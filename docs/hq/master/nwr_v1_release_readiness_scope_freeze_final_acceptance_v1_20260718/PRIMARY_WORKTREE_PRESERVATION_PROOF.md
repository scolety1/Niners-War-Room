...
The primary worktree was not inspected beyond the five required path/hash/status checks and repository worktree metadata. None of the five user-owned DynastyProcess CSVs was normalized, restored, staged, committed, copied, or pushed.
...
The primary status remained exactly those five user-owned modifications at the required checks. Any later mismatch invalidates adoption.
