...
The primary worktree retained exactly its five user-owned modified paths. Contents were not inspected, parsed, summarized, normalized, copied, staged, committed, or pushed. Preservation-only SHA-256 values remained:
...
These hashes assert preservation only, not canonical data approval.
