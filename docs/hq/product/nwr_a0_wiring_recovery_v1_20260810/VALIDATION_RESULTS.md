...
- Fresh adoption worktree: recovery commit cherry-picked cleanly onto live HQ; 86 + 74 tests passed and eight owner routes returned HTTP 200.
...
- Canonical push: normal fast-forward; no force push.
