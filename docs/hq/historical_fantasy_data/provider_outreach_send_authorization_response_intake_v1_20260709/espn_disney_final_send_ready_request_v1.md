# ESPN / Disney Final Send-Ready Request V1
...
Before sending, complete `provider_send_authorization_checklist_v1.md`. After any reply, log metadata in `provider_response_intake_ledger_template_v1.csv`. Do not use public client objects as admitted feeds without a separate source-admission lane.
