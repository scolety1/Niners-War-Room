...
CSV_SCHEMAS: dict[str, CsvSchema] = {
    ...
    "fact_rosters.csv": CsvSchema(
        ...
        integer_columns=("season", "league_rank", "official_rank"),
    ),
    "fact_official_rankings.csv": CsvSchema(
        ...
        integer_columns=("season", "league_rank", "official_rank", "is_rank_placeholder"),
    ),
    ...
    "model_outputs.csv": CsvSchema(
        ...
        integer_columns=("overall_rank", "position_rank"),
        float_columns=(
            "private_score",
            "market_score",
            "war_score",
