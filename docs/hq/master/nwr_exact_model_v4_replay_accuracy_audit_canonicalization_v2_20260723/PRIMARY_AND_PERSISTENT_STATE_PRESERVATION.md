...
The primary worktree at `C:\NWR\Niners-War-Room` remains preserved. Its five
user-owned DynastyProcess files were treated as opaque and checked only by
SHA-256:
...
They were not inspected, parsed, normalized, copied, restored, staged, or
committed.

Live metadata-only verification remains exact:
...
No real user state was modified to obtain these proofs.
