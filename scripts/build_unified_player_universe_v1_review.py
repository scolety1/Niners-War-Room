...
def main() -> None:
    ...
    print(f"consolidated_review_path={result.consolidated_review_path}")
    print(f"consolidation_decisions_path={result.consolidation_decisions_path}")
    print(f"remaining_blockers_path={result.remaining_blockers_path}")
    print(f"source_summary_path={result.source_summary_path}")
    print(f"total_rows={result.total_rows}")
    print(f"consolidated_rows={result.consolidated_rows}")
    ...
    print(f"duplicate_groups_handled={result.duplicate_groups_handled}")
    print(f"identity_gap_count={result.identity_gap_count}")
    print(f"remaining_blocker_count={result.remaining_blocker_count}")
