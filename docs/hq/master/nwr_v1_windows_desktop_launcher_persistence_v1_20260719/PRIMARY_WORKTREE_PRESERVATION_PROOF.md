...
The primary worktree was never checked out, staged, committed, copied, normalized, or used for tests. Hash-only verification was performed at required checkpoints.
