...
This work order is automatically dispatchable under `BOUNDED_CONTINUOUS_AUTOPILOT` only after its phase identity and SHA-256 match `GOLDEN_LANE_AUTOPILOT_STATE.json` and every automatic-advance gate passes. No owner paste or routine phase approval is required.
