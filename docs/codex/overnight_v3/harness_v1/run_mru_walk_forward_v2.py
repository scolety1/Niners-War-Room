...
OUT_PATH = THIS_BRANCH_ROOT / "docs/codex/overnight_v3/harness_v1/mru_walk_forward_v2_report.json"
...
TEAM_COUNTS = (10, 12)  # scoped down from the corpus's {8, 10, 12, 16} -- disclosed above
BASE_SEED = 20260905
ROSTER_SLOTS_DICT = {
